...
This project is on using doubly-linked lists in C.

## Tests :heavy_check_mark:

* [main_files](./main_files): Test files folder.

## Header File :

* [lists.h](./lists.h): Header file containing prototypes for struct and functions for the project.

## Tasks :

* **0. Print list**
  * [0-print_dlistint.c](./0-print_dlinstint.c): C function that prints all the elements of a doubly-linked `dlistint_t` list.
